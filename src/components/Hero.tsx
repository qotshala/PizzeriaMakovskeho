    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <div className="mb-4 inline-block">
          <span className="gold-accent text-sm md:text-base uppercase tracking-[0.4em] font-bold">
            Tradiční Italská Chuť
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#menu"
            className="w-full sm:w-auto bg-gold text-black px-10 py-4 uppercase tracking-widest font-bold hover:bg-yellow-600 transition duration-300 shadow-xl"
          >
            Zobrazit Menu
          </a>
          <button
