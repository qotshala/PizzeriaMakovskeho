  ...
  return (
    <section id="menu" className="py-20 bg-[#0f0f0f]">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto text-lg italic">
            <div className="bg-black p-4 border border-gray-800 rounded">
              <span className="gold-accent font-bold">PIZZA A:</span> 33cm - 250
              Kč | 40cm - 285 Kč
            </div>
            <div className="bg-black p-4 border border-gray-800 rounded">
              <span className="gold-accent font-bold">PIZZA B:</span> 33cm - 275
              Kč | 40cm - 320 Kč
            </div>
          </div>
        ...
        <h3 className="text-3xl font-bold mb-10 border-l-4 border-gold pl-4 uppercase tracking-wider italic">
          Sekce A
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {pizzaA.map((pizza, index) => (
            <div
              key={index}
              className="pizza-card bg-black border border-gray-800 rounded-2xl overflow-hidden transition"
            >
              <img
                src={pizza.img}
              ...
              />
              <div className="p-6">
                <h4 className="text-xl font-bold mb-2 italic text-white">
                  {index + 1}. {pizza.name}
                </h4>
        ...
        <h3 className="text-3xl font-bold mb-10 border-l-4 border-red-600 pl-4 uppercase tracking-wider italic">
          Sekce B
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {pizzaB.map((pizza, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h4
                  className={`text-xl font-bold mb-2 italic ${pizza.special ? "gold-accent" : "text-white"}`}
                >
